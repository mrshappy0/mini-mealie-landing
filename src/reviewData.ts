...
export const reviews: Review[] = [
    {
        ...
        stars: 5,
        reviewText:
            "Super cool! Nice work on this. Makes Mealie much easier and way more efficient for desktop users.",
    },
    {
    ...
    },
    {
        ...
        stars: 5,
        reviewText:
            "Makes saving recipes even faster. More tips/instruction on how to initially set up the extension would be helpful but overall awesome tool.",
    },
];
